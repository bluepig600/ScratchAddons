export default async function ({ addon, msg }) {
  if (addon.auth.fetchIsLoggedIn()) {
    const loggedInUser = await addon.auth.fetchUsername(); // get username
    const userPosts = document.querySelectorAll(".postleft dt a.username");
